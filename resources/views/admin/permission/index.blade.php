                        ...
                        @can('permission create')
                            <div class="d-print-none with-border mb-8">
                                <a href="{{ route('permission.create') }}"
                                   class="bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">{{ __('Add Permission') }}</a>
                            </div>
                        @endcan
                                                    ...
                                                    <form action="{{ route('permission.destroy', $permission->id) }}"
                                                        ...
                                                        @can('permission edit')
                                                            <a href="{{route('permission.edit', $permission->id)}}"
                                                               class="px-4 py-2  mr-4 bg-blue-600">
                                                                {{ __('Edit') }}
                                                            </a>
                                                        @endcan
